...
class TransactionsPage {
  ...
  formatDate(date){
    date = new Date(date);
    const newDate = date.toLocaleDateString('ru-RU', { year: "numeric", month: "long", day: "numeric" });
    const newTime = date.toLocaleTimeString('ru-RU', { hour: "numeric", minute: "numeric" });
